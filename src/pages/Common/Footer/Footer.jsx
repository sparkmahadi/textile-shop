        ...
        <div className='footer-bg text-white'>
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-6 lg:max-w-sm">
                            <p className="text-sm text-white">
                                Textile Shop is a company which provides various informations about the courses and skills you can develop for yourself in different sections of Information Technology.
                            </p>
                ...
                <div className="text-center pt-5 pb-10 border-t lg:flex-row">
                    <p className="text-sm text-white">
                        © Copyright 2022 Textile Shop Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
